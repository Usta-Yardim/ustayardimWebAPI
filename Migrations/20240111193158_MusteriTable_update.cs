...
{
    /// <inheritdoc />
    public partial class MusteriTable_update : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
           ...
           /* migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    ProfilImgPath = table.Column<string>(type: "TEXT", nullable: true),
                    FavoriUstaId = table.Column<int>(type: "INTEGER", nullable: false),
                    IlinfoIlId = table.Column<int>(type: "INTEGER", nullable: true),
                    IlceinfoIlceId = table.Column<int>(type: "INTEGER", nullable: true),
                    MahalleinfoMahalleId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Musteriler", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_Musteriler_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Musteriler_Ilceler_IlceinfoIlceId",
                        column: x => x.IlceinfoIlceId,
                        principalTable: "Ilceler",
                        principalColumn: "IlceId");
                    table.ForeignKey(
                        name: "FK_Musteriler_Iller_IlinfoIlId",
                        column: x => x.IlinfoIlId,
                        principalTable: "Iller",
                        principalColumn: "IlId");
                    table.ForeignKey(
                        name: "FK_Musteriler_Mahalleler_MahalleinfoMahalleId",
                        column: x => x.MahalleinfoMahalleId,
            ...
            /*migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferansImgPath = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ustalar", x => x.UserId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ustalar_Ilceler_IlceinfoIlceId",
                        column: x => x.IlceinfoIlceId,
                        principalTable: "Ilceler",
                        principalColumn: "IlceId");
                    table.ForeignKey(
                        name: "FK_Ustalar_Iller_IlinfoIlId",
                        column: x => x.IlinfoIlId,
                        principalTable: "Iller",
                        principalColumn: "IlId");
                    table.ForeignKey(
                        name: "FK_Ustalar_Mahalleler_MahalleinfoMahalleId",
                        column: x => x.MahalleinfoMahalleId,
                        principalTable: "Mahalleler",
                        principalColumn: "MahalleId");
                });*/
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Musteriler_IlceinfoIlceId",
                table: "Musteriler",
                column: "IlceinfoIlceId");

            migrationBuilder.CreateIndex(
                name: "IX_Musteriler_IlinfoIlId",
                table: "Musteriler",
                column: "IlinfoIlId");

            migrationBuilder.CreateIndex(
                name: "IX_Musteriler_MahalleinfoMahalleId",
                table: "Musteriler",
                column: "MahalleinfoMahalleId");

           /* migrationBuilder.CreateIndex(
                name: "IX_Ustalar_IlceinfoIlceId",
                table: "Ustalar",
                column: "IlceinfoIlceId");

            migrationBuilder.CreateIndex(
                name: "IX_Ustalar_IlinfoIlId",
                table: "Ustalar",
                column: "IlinfoIlId");

            migrationBuilder.CreateIndex(
                name: "IX_Ustalar_MahalleinfoMahalleId",
                table: "Ustalar",
                column: "MahalleinfoMahalleId");*/
        }
